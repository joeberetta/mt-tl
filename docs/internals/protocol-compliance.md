...
| **Inbound `msg_key`**                | MTProto 2.0 integrity check.                                                                                                                   | Implemented + enforced (gated by `disableMsgKeyCheck`); see [msgkey-v1-quirk.md](msgkey-v1-quirk.md) for the real-client v1 deviation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ✅ + shim    |
...
- **`disableMsgKeyCheck`** (env `DISABLE_MSG_KEY_CHECK`) — drops the inbound MTProto
  2.0 `msg_key` integrity check. ⚠️ insecure; see [msgkey-v1-quirk.md](msgkey-v1-quirk.md).
